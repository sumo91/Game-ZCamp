...
const enemies: EnemyDefinition[] = [
  { id: "walker", displayName: "行尸", role: "基础推进", tier: "normal", behavior: "walker", maxHp: 36, moveSpeed: 0.14, wallDamage: 5, wallAttackIntervalSeconds: 0.8, goldReward: 2, xpReward: 1 },
  { id: "runner", displayName: "疾行者", role: "高速突破", tier: "normal", behavior: "runner", maxHp: 24, moveSpeed: 0.28, wallDamage: 4, wallAttackIntervalSeconds: 0.75, goldReward: 2, xpReward: 1 },
  { id: "tank", displayName: "重装尸", role: "高生命推进", tier: "normal", behavior: "tank", maxHp: 110, moveSpeed: 0.08, wallDamage: 12, wallAttackIntervalSeconds: 1, goldReward: 6, xpReward: 3 },
  { id: "splitter", displayName: "裂变尸", role: "死亡分裂", tier: "normal", behavior: "splitter", maxHp: 48, moveSpeed: 0.12, wallDamage: 6, wallAttackIntervalSeconds: 0.8, goldReward: 4, xpReward: 2, splitInto: { enemyId: "runner", count: 2 } },
  { id: "screamer", displayName: "尖啸者", role: "尸潮加速", tier: "normal", behavior: "screamer", maxHp: 55, moveSpeed: 0.11, wallDamage: 4, wallAttackIntervalSeconds: 0.8, goldReward: 5, xpReward: 2 },
  { id: "volatile", displayName: "爆裂尸", role: "死亡冲击", tier: "normal", behavior: "volatile", maxHp: 30, moveSpeed: 0.18, wallDamage: 5, wallAttackIntervalSeconds: 0.7, goldReward: 4, xpReward: 2, onDeathWallDamage: 8 },
  { id: "armored", displayName: "装甲精英", role: "减伤推进", tier: "elite", behavior: "armored", maxHp: 90, moveSpeed: 0.1, wallDamage: 8, wallAttackIntervalSeconds: 0.9, goldReward: 8, xpReward: 3, damageMultiplier: 0.55 },
  { id: "regenerator", displayName: "再生精英", role: "持续回复", tier: "elite", behavior: "regenerator", maxHp: 100, moveSpeed: 0.09, wallDamage: 7, wallAttackIntervalSeconds: 0.8, goldReward: 9, xpReward: 4, regenPerSecond: 4 },
  { id: "burrower", displayName: "潜行精英", role: "接近后显形", tier: "elite", behavior: "burrower", maxHp: 60, moveSpeed: 0.22, wallDamage: 6, wallAttackIntervalSeconds: 0.8, goldReward: 9, xpReward: 4, untargetableUntil: 0.55 },
  { id: "brute", displayName: "攻城精英", role: "高额攻墙", tier: "elite", behavior: "brute", maxHp: 140, moveSpeed: 0.07, wallDamage: 18, wallAttackIntervalSeconds: 1.1, goldReward: 12, xpReward: 5 },
  { id: "charger_boss", displayName: "冲锋领主", role: "周期冲锋", tier: "boss", behavior: "charger", maxHp: 280, moveSpeed: 0.11, wallDamage: 28, wallAttackIntervalSeconds: 0.9, goldReward: 28, xpReward: 12 },
  { id: "summoner_boss", displayName: "巢穴领主", role: "死亡召唤", tier: "boss", behavior: "summoner", maxHp: 340, moveSpeed: 0.08, wallDamage: 24, wallAttackIntervalSeconds: 0.9, goldReward: 32, xpReward: 14, splitInto: { enemyId: "runner", count: 4 } },
  { id: "fortress_boss", displayName: "壁垒领主", role: "极高减伤", tier: "boss", behavior: "fortress", maxHp: 560, moveSpeed: 0.05, wallDamage: 38, wallAttackIntervalSeconds: 1.2, goldReward: 40, xpReward: 18, damageMultiplier: 0.35 },
  { id: "overlord_boss", displayName: "尸潮君王", role: "全场统御", tier: "boss", behavior: "overlord", maxHp: 720, moveSpeed: 0.07, wallDamage: 48, wallAttackIntervalSeconds: 1.1, goldReward: 60, xpReward: 24, damageMultiplier: 0.5 },
];
